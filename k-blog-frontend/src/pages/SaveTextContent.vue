      ...
      <iv-col :xs="24" :sm="24" :md="24" :lg="17">
        ...
        <iv-form ref="article" :model="article" :label-width="0">
          ...
          <iv-formItem label="文章标题：">
            <iv-input placeholder="请填写文章标题..." :maxlength="10" v-model="article.articleName"
                      style="width: 300px"></iv-input>
          </iv-formItem>

          <iv-formItem label="文章内容：">
            <mavon-editor ref=md @imgAdd="imgAdd" v-model="article.articleContent" :toolbars="toolbars"
          ...
          <iv-formItem label="文章备注：">
            <iv-input type="textarea" placeholder="请填写文章备注..." v-model="article.articleRemark" :maxlength="100"
                      style="width: 500px"></iv-input>
          </iv-formItem>
