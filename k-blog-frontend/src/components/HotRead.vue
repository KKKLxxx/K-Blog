      ...
      <div slot="content" class="content">
        <div class="top">
          <a :href="'/' + topHotRead.urlType + '/' + topHotRead.linkId">
            ...
            <div class="tags">
              <iv-tag :color="index | mapTagColor" v-for="(tag , index)  in topHotRead.tagList" :key="tag.id">
                {{ tag.name }}
              </iv-tag>
            </div>
            <p class="info">
          ...
          <li v-for="hotRead in hotReadList" :key="hotRead.id">
            <a :href="'/' + hotRead.urlType + '/' +hotRead.linkId">
              ...
              <p class="info">
                ...
                <span class="comments"><a href=""><iv-icon
                  type="compose"></iv-icon> {{ hotRead.commentNum }} </a></span>
